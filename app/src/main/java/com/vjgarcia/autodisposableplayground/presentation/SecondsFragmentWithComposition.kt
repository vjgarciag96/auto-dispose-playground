...
class SecondsFragmentWithComposition : Fragment() {

    private val viewModel by viewModel<SecondsViewModelWithComposition>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        title.text = getString(R.string.view_model_with_composition_sample)
    ...
    private fun bindViewModel() {
        viewModel.seconds.observe(::getLifecycle) { secondsValue ->
    ...
    companion object {
        fun instance(): Fragment = SecondsFragmentWithComposition()
    }
}